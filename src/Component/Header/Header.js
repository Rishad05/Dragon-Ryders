...
const Header = () => {
    ...
    return (
        <div>
            ...
            <Navbar.Brand  className=" rounded text-light p-3" href="/home"><h2>Dragon Ryders</h2></Navbar.Brand>
            <Navbar.Toggle aria-controls="basic-navbar-nav" />
            <Navbar.Collapse className="justify-content-end ">
                <Link className="text-light nav-link" to="/home">Home</Link>
                <Link  className="text-light nav-link" to="/destination">Destination</Link>
